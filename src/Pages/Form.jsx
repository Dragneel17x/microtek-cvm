...
function Form() {
  ...
  return (
    ...
    />} */}
      ...
      >
        <div>
          <h4>Customer Group: <span>{formData.cust_group}</span></h4>
          <h4>Customer Name: <span>{formData.cust_name} {formData.cust_name_op1}</span></h4>
          <h4>Customer Address: <span>{formData.cust_address} {formData.cust_address_op1} {formData.cust_address_op2} {formData.cust_address_op3}</span></h4>
          ...
          <h4>Reconciliation A/C: <span>{formData.recon_acc}</span></h4>
          <h4>PayTerm: <span>{formData.pay_term}</span></h4>
          <h4>Sales Organization: <span>{formData.sales_org}</span></h4>
          <h4>Distribution Channel: <span>{formData.dist_channel}</span></h4>
          <h4>Division: <span>{formData.division}</span></h4>
          <h4>Transportation Zone: <span>{formData.transportation_zone}</span></h4>
          <h4>Mobile Number: <span>{formData.mobile_no}</span></h4>
          <h4>E-mail ID: <span>{formData.email_id}</span></h4>
          <h4>Company Code: <span>{formData.company_code}</span></h4>
          <h4>Sales-District: <span>{formData.sales_district}</span></h4>
          <h4>Customer Account Group: <span>{formData.customer_acc_group}</span></h4>
          <h4>Sales Office and Delivery Plant: <span>{formData.sales_office}</span></h4>
